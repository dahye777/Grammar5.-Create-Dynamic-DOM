...
createElement 이 메소드는 단일 매개변수 값을 받고, 필수로 받아야 합니다
=> 요소 객체가 생성이 됩니다
...
// }
// // createAttribute('targe'); + setAttributeNode(target)
// //  a.setAttribute("속성이름", "속성에 넣을 값");

// a.innerText = "네이버";
// /* <a href="https://www.naver.com" target="_blank">네이버</a> */

// h1.append(a);
// /*<h1><a href="https://www.naver.com" target="_blank">네이버</a><h1> */

// document.body.append(h1);
//최종적으로 이어서 붙인 h1을 문서의 body태그 안에 붙여주어야 최종 생성됩니다

// 여기까지가 1. node를 생성하여 동적DOM을 만드는 방법으로써 어렵고, 복잡하지만 알고는 있어야 하는 방법

//2. 문자열을 innerHTML로 조합하여 DOM을 생성하는 방식
...
//3. 템플릿 리터럴을 활용한 객체 형식의 DOM형성방법 =  실무적인 내용입니다
//실무에서는 자료를 복수개인 경우 객체나, 배열을 바인딩을 해야합니다
// 또한 문자열 안에 변수를 넣는 경우 에크마6의 문법인 템플릿 리터럴을 사용합니다
...
let tags = "";
// map반복에서는 두가지의 매개변수자리가 존재합니다.
//el, index 각각의 개체를 의미하는 el과 반복을 도는 각 인덱스를 의미하는 index라는 매개변수가 필요하죠
// 하지만 반복대상에 따라서 어느 하나의 매개변수는 쓰지 않을 때도 있습니다
// 쓰지 않기에 지운다면 에러가 발생합니다 따라서 지우진 않고, 쓰지 않아서 el에 색상이 변경되는 것을 피하기 위해서 _로 표현하기도 합니다
